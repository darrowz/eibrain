...
def test_classifies_supported_event_fixture_routes() -> None:
    expected_routes = {
        ...
        "fast_hypothesis.json": "dialogue_fast_hypothesis",
        "dialogue_decision_stable.json": "dialogue_decision_stable",
        "realtime_vision_frame.json": "realtime_vision_frame",
        "head_status_report.json": "head_status_report",
...
def test_classifies_v01_mvp_routes_with_metadata() -> None:
    cases = [
        ...
        ("ei.observation.head.status.report", "observation", "head_status_report", "observation", False, False, True),
        ("ei.dialogue.fast_hypothesis", "dialogue", "dialogue_fast_hypothesis", "dialogue", False, True, True),
        ("ei.dialogue.decision.stable", "dialogue", "dialogue_decision_stable", "dialogue", False, True, True),
